...
void menugame()
{
	...
	printf("   \t  Nguyen Nho Thanh Dat\t   Nguyen Do Cuong");
	gotoxy(0, 0);
	}
	int key;
	while(true)
	{
		xytext(43, 12, 12, "START GAME");
		xytext(43, 14, 12, "EXIT");
...
void GUItext()
{
	xytext(5, 0, 15, " SNAKE GAME Ver0.5 ");
	xypoint(50, 25, 15, "Point: ", point-3);
	/*{
		xytext(58, 12, 12, "AUTHOR");
		xytext(55, 14, 12, "Vu Nhat Thanh");
		xytext(53, 16, 12, "P.T. Phong Nguyen");
		xytext(54, 18, 12, "N.N. Thanh Dat");
		xytext(54, 20, 12, "Nguyen Do Cuong");
	}*/
...
void processing()
{
	...
	if (snake[0].x > (room_width - 1) || snake[0].x == 1 || snake[0].y > (room_height - 2) || snake[0].y == 0 || endgame != 0)
	{
